...
class DNNGeneticEvolutionSolver(BaseModel):

    model = None

    def __init__(self):
        BaseModel.__init__(self, "Deep Neural Net GE", "deep_neural_net_genetic_evolution", "dnnge")
...
class DNNGeneticEvolutionTrainer(BaseModel):
    ...
    def __init__(self):
        BaseModel.__init__(self, "Deep Neural Net GE", "deep_neural_net_genetic_evolution_trainer", "dnnget")
