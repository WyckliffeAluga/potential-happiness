# -*- coding: utf-8 -*-
"""
Created on Sun Jul  5 12:44:53 2020
...
from out_world import Inception
from utils import save, resize, normalize
...
class DeepDream:
    ...
    def recursively_optimize(self, layer, image, levels, rescale_factor, blend, iterations, step_size):
        ...
        if levels > 0:
            ...
            downscaled = resize(image=blurred, factor=rescale_factor)
            ...
            upscaled = resize(image=final_image, size=image.shape[0:2])
...
def main():
    ...
    for i, layer_index in enumerate(layer_indices):
        ...
        final_image = deep_dream.recursively_optimize(layer=layer,
                                                      ...
                                                      levels=LEVELS,
                                                      blend=BLEND)
    save(final_image, OUTPUT_IMAGE_NAME + ".jpeg")
